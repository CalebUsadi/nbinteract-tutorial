...
var WebIODomNode = /** @class */ (function (_super) {
    ...
    function WebIODomNode(nodeData, options) {
        ...
        debug("Creating WebIODomNode", { nodeData: nodeData, options: options, node: _this });
    ...
    WebIODomNode.prototype.applyEvents = function (events) {
        ...
        for (var _i = 0, _a = Object.keys(events); _i < _a.length; _i++) {
            ...
            var newListener = newListenerSource && events_1.createWebIOEventListener(this.element, newListenerSource, { scope: this.scope, webIO: this.webIO });
