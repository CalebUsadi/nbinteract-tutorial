...
import { WebIOMessage, WebIORequest, WebIORequestType, WebIOResponse } from "./message";
...
export declare type WebIOSendCallback = (message: WebIOMessage) => void;
declare class WebIO {
    /**
     ...
     */
    dispatch(message: WebIOMessage): void | Promise<void>;
    ...
    sendRequest<T extends WebIORequestType>(message: WebIORequest<T>): Promise<WebIOResponse<T>>;
    RPC(rpcId: string, args: any[]): Promise<unknown>;
    /**
     ...
     * await rpc(4, 5, 6);
     */
    getRPC: (rpcId: string) => (...args: any[]) => Promise<unknown>;
    /**
    ...
    addDispatchListener(listener: WebIO["dispatch"]): void;
    removeDispatchListener(listener: WebIO["dispatch"]): void;
    importResource: (importData: import("./imports").ConcreteImport) => any;
    importBlock: (importData: import("./imports").BlockImport, config?: import("systemjs").Config | undefined) => Promise<import("./imports").BlockImportResult>;
}
