...
export declare type RPCResponse = RPCOkayResponse | RPCExceptionResponse;
...
export declare const enum WebIORequestType {
    EVAL = "eval",
    RPC = "rpc"
}
export declare const enum WebIOCommandType {
 ...
 * }
 */
export declare type WebIORequest<T extends WebIORequestType = WebIORequestType> = WebIORequestByType[T];
export declare type WebIOResponse<T extends WebIORequestType = WebIORequestType> = WebIOResponseByType[T];
export declare type WebIOCommand<T extends WebIOCommandType = WebIOCommandType> = WebIOCommandByType[T];
...
export declare type WebIOMessage = WebIORequest | WebIOCommand | WebIOResponse;
export {};
