 ...
 */
export declare const createWebIOEventListener: (_webIOThis: WebIODomElement | WebIOScope, _webIOListenerSource: string | EventListener, _webIOContext: WebIONodeContext) => EventListener;
export declare const evalWithWebIOContext: (_webIOThis: WebIODomElement | WebIOScope, _webIOListenerSource: string | EventListener, _webIOContext: WebIONodeContext) => unknown;
