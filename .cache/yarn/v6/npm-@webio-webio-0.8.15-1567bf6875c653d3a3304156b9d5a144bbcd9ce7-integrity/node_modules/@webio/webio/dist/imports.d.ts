...
export declare const importJSUrl: (name: string, url: string) => Promise<any>;
export declare const importJS: (importData: JSImport) => any;
/**
 * Import some href/url in a `<link />` tag.
 * @param url
 */
export declare const importLink: (url: string, options: {
    rel?: string;
    type?: string;
    media?: string;
}) => Promise<unknown>;
export declare const importCSS: (importData: CSSImport) => Promise<unknown>;
export declare const importSyncBlock: (importData: SyncBlockImport) => Promise<BlockImportResult>;
export declare const importAsyncBlock: (importData: AsyncBlockImport) => Promise<BlockImportResult>;
/**
 * Import a _thing_.
 * @param importData
 */
export declare const importResource: (importData: ConcreteImport) => any | null;
export declare const importBlock: (importData: BlockImport, config?: SystemJS.Config | undefined) => Promise<BlockImportResult>;
