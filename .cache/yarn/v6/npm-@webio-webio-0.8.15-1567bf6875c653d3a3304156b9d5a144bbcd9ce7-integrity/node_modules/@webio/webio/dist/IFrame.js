...
exports.IFRAME_NODE_TYPE = void 0;
...
var WebIOIFrame = /** @class */ (function (_super) {
    ...
    function WebIOIFrame(iframeData, options) {
        ...
        _this.children = null;
        _this.dispatchListener = undefined;
        ...
        var _a = iframeData.instanceArgs, innerHTML = _a.innerHTML, bundleURL = _a.bundleURL;
        iframe.onload = function () { return _this.initializeIFrame(innerHTML, bundleURL); };
        return _this;
    }
    /**
     ...
     * @param bundleURL
     */
    WebIOIFrame.prototype.initializeIFrame = function (innerHTML, bundleURL) {
        return __awaiter(this, void 0, void 0, function () {
            var iframe, iframeWindow, iframeDocument, baseTag, webIOScript, iframeWebIO;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        iframeWindow._webIOSkipWebSocket = true;
                        webIOScript = iframeDocument.createElement("script");
                        webIOScript.src = bundleURL;
                        iframeDocument.body.appendChild(webIOScript);
                        return [4 /*yield*/, this.waitForWebIO(iframeWindow)];
                    case 1:
                        _a.sent();
                        iframeWebIO = iframeWindow.WebIO;
     ...
     * @param interval
     */
    WebIOIFrame.prototype.waitForWebIO = function (iframeWindow, interval) {
        if (interval === void 0) { interval = 100; }
        var future = new Future_1.default();
        var wait = function () {
            if (typeof iframeWindow.WebIO === "undefined") {
                debug("IFrame doesn't have WebIO, waiting " + interval + "ms...");
                return setTimeout(wait, interval);
            }
            future.resolve(iframeWindow.WebIO);
        };
        wait();
        return future;
    };
