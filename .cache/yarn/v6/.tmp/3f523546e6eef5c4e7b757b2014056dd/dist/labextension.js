...
var WebIORenderer = /** @class */ (function (_super) {
    ...
    WebIORenderer.prototype.renderModel = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            var kernelId, currentKernelId, div, p, strong, data;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (kernelId !== currentKernelId) {
                            log("WebIORenderer\u00ACrenderModel: output was generated for kernelId \"" + kernelId + "\", "
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _b = (_a = model).setData;
                        _e = {};
                        _c = [__assign({}, model.metadata)];
                        _f = {};
                        _d = WEBIO_METADATA_KEY;
                        _g = {};
                        return [4 /*yield*/, this.webIOManager.getKernel()];
                    case 1:
                        _b.apply(_a, [(_e.metadata = __assign.apply(void 0, _c.concat([(_f[_d] = (_g.kernelId = (_h.sent()).id,
                                    _g), _f)])),
                                _e)]);
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        session = this.context.sessionContext.session;
                        if (!session) {
...
var WebIONotebookExtension = /** @class */ (function () {
    ...
    WebIONotebookExtension.prototype.createNew = function (notebook, context) {
        ...
        var rendermime = notebook.content.rendermime;
